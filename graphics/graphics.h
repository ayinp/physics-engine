...
public:
   ...
   // void   callPlugin(int pluginId, int arg1, int arg2, const std::string& arg3);
    ...
    void   polygon(const std::vector<Vec2d>& points, Color border, Color fill = TRANSPARENT);
    void   polyline(const std::vector<Vec2d>& points, Color color);
    void   points(const std::vector<Vec2d>& points, Color c);

    void   polygon(const Array<Vec2d>& points, Color border, Color fill = TRANSPARENT);
    void   polyline(const Array<Vec2d>& points, Color color);
    void   points(const Array<Vec2d>& points, Color c);

    void   polygon(std::initializer_list<Vec2d> points, Color border, Color fill = TRANSPARENT);
    void   polyline(std::initializer_list<Vec2d> points, Color color);
    void   points(std::initializer_list<Vec2d> points, Color c);
    ...
    double textWidth(double size, const std::string& str);
